...
double TaylorApproximator(enum function_to_approximate, int degree_to_approximate, bool isMacLaurin, double point_to_approximate_around, double point) ; //In progress
